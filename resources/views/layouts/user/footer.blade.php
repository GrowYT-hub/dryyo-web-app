    ...
    <footer class="footer">
        ...
        <div class="footer-content">
            <div class="footer-content-column">
                <div class="footer-logo">
                    <a class="footer-logo-link" href="#">
                         <img src="{{url('public/'.$settings->footer_logo) }}" class="header-brand-img desktop-logo" alt="logo">
                    </a>
                </div>
            ...
            <div class="footer-content-column">
                ...
                <div class="footer-call-to-action">
                    ...
                    <p class="footer-call-to-action-link-wrapper"><a class="footer-call-to-action-link"
                                                                     href="tel:0124-64XXXX" target="_self">
                            0124-64XXXX </a></p>
                </div>
            </div>
            <div class="footer-social-links">
                ...
                <a class="footer-social-link linkedin" href="{{$settings->linkedin_link}}" target="_blank">
                ...
                <a class="footer-social-link twitter" href="{{$settings->facebook_link}}" target="_blank">
                ...
                <a class="footer-social-link youtube" href="{{$settings->youtube_link}}" target="_blank">
                ...
                <a class="footer-social-link github" href="{{$settings->instagram_link}}" target="_blank">
        ...
        <div class="footer-copyright">
            <div class="footer-copyright-wrapper">
                <p class="footer-copyright-text">
                    <a class="footer-copyright-link" href="#" target="_self"> ©2020. | Designed By: Chetan
                        Sawle. | All rights reserved. </a>
                </p>
            </div>
        </div>
    </footer>
