                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a class="header-brand" href="index.html">
                                <img src="{{ url('public/'.$settings->logo) }}" class="header-brand-img logo-3" alt="Sash logo">
                                <img src="{{ url('public/'.$settings->logo) }}" class="header-brand-img logo" alt="Sash logo">
                            </a>
                            <div>
{{--                                <address class="pt-3">--}}
{{--                                    {{ $invoice->address }}<br>--}}
